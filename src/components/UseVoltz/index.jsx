      ...
      <div className="hidden md:flex flex-col desktop-container px-[32px] 2xl:px-[0px] py-[72px] !items-start relative">
        ...
        <div className="grid grid-cols-2 w-full py-[48px] gap-y-[32px] gap-x-[88px]">
          ...
          <div className="flex justify-start space-x-[16px] items-start">
            <img src="/assets/right-arrow-icon.svg" className="w-[30px]" />
            <div className="flex-1 text-white text-lg">
              <span>Sincronización de stock y precios de cientos de distribuidores y fabricantes.</span>
            </div>
          </div>
          ...
          <div className="flex justify-start space-x-[16px] items-start">
            <img src="/assets/right-arrow-icon.svg" className="w-[30px]" />
            <div className="flex-1 text-white text-lg">
              <span>Utilización de inteligencia artificial para encontrar justo lo que necesitas</span>
            </div>
          </div>
          ...
          <div className="flex justify-start space-x-[16px] items-start">
            <img src="/assets/right-arrow-icon.svg" className="w-[30px]" />
            <div className="flex-1 text-white text-lg">
              <span>Simplificación del proceso de pago, entrega y facturación.</span>
            </div>
          </div>
        ...
        <img src="/assets/hand.png" loading="lazy" className="absolute h-[200px] right-0 lg:right-[20%] top-[-5%]" />
      </div>
    </div>
  );
};
