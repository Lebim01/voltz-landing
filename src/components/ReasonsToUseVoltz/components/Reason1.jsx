...
const Reason1 = () => {
  return (
    <div className="flex flex-col md:flex-row space-y-[28px] md:space-y-[0px] md:space-x-[60px] md:items-center">
      <div>
        <img src="/assets/reasons/reason-1.svg" className="w-[150px] md:w-[256px]" loading="lazy" />
      </div>
      <div className="flex flex-col space-y-[24px]">
        ...
        <div className="flex flex-col space-y-[16px]">
          <span className="text-lg md:text-2xl text-text-primary">Encuentra todo en un solo lugar.</span>
