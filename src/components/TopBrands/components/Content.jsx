  ...
  return (
    <div className="bg-white rounded-[6px] flex flex-col justify-between items-center space-y-[34px] box-border h-full w-full py-[24px]">
      <div className="flex-1 w-3/5 flex justify-center items-center">
        <img src={prod.image} className="w-3/5 max-h-[72px] md:max-h-[120px] max-w-[72px] md:max-w-[120px] object-contain aspect-square" alt="brand image" />
      </div>
      <div className="flex space-x-[-8px] lg:space-x-[-22px] xl:space-x-[-16px]">
        <img
  ...
  return (
    <div className="bg-border-1 px-[16px] py-[16px] lg:py-[64px]">
      <div className="desktop-container">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-[16px] lg:gap-x-[20px] py-[16px] lg:px-[80px]">
